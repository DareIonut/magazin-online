        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId="image">
              ...
              <Form.Control
                type="text"
                placeholder="Introdu URL imagine"
                value={image}
            ...
            <Form.Group controlId="brand">
              ...
              <Form.Control
                type="text"
                placeholder="Introdu brandul produsului"
                value={brand}
                onChange={(e) => setBrand(e.target.value)}
              ></Form.Control>
            </Form.Group>
            <Form.Group controlId="countInStock">
              <Form.Label>Cantitatea disponibilă în stoc</Form.Label>
              <Form.Control
                type="number"
            ...
            <Form.Group controlId="category">
              ...
              <Form.Control
                type="text"
                placeholder="Introdu categoria produsului"
                value={category}
